...
//         $playerCards = array_filter([array_shift($cards), array_shift($cards)]);
//         $dealerCards = array_filter([array_shift($cards), array_shift($cards)]);

//         $playerPoints = $this->rules->countPoints($playerCards);
//         $dealerPoints = $this->rules->countPoints($dealerCards);

//         $this->state->setPlayerCards(array_values($playerCards), $session);
//         $this->state->setDealerCards(array_map([$this, 'cardToArray'], array_values($dealerCards)), $session);
//         $this->state->setDeck($cards, $session);
//         $this->state->setPoints($session, 'player_points', $playerPoints);
//         $this->state->setPoints($session, 'dealer_points', $dealerPoints);
//         $session->set('game_started', true);
...
//         if ($this->rules->countPoints($playerCards) < 21 && $newCard !== null) {
//             $playerCards[] = $newCard;
//         }
...
//                 $hand1[] = $newCard;
//                 $points1 = $this->rules->countPoints($hand1);
//                 $this->state->setHand($session, "hand1", array_map([$this, 'cardToArray'], $hand1));
//                 $this->state->setPoints($session, "player_points_1", $points1);
...
//                 $hand2[] = $newCard;
//                 $points2 = $this->rules->countPoints($hand2);
//                 $this->state->setHand($session, "hand2", array_map([$this, 'cardToArray'], $hand2));
//                 $this->state->setPoints($session, "player_points_2", $points2);
...
//         $this->state->setDealerCards(array_map([$this, 'cardToArray'], $dealerCards), $session);
//         $this->state->setDeck($cards, $session);
//         $this->state->setPoints($session, 'dealer_points', $dealerPoints);
//         $session->set('game_started', false);
...
//     /**
//      * @param Card $card
//      * @return array{value: string, suit: string, card: string}
//      */
